...
from user.train_agent import UserInputAgent, BasedAgent, ConstantAgent, ClockworkAgent, SB3Agent, RecurrentPPOAgent, gen_reward_manager #add anymore custom Agents (from train_agent.py) here as needed
...
run_real_time_match(
    ...
    reward_manager=gen_reward_manager(2),
)
